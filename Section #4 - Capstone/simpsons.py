...
if __name__ == '__main__':
    IMG_SIZE = (80, 80)
    channels = 1
    char_path = './Section #4 - Capstone/simpsons_dataset'
    ...
    test_path = r'C:\Users\pooya\Desktop\python projects\OpencCv\OpencCv- tutorial\Section #4 - Capstone\kaggle_simpson_testset\kaggle_simpson_testset\abraham_grampa_simpson_0.jpg'
